...
/// Service bọc lại package `did_change_authlocal` để phát hiện
/// dữ liệu sinh trắc học trên thiết bị có bị thay đổi hay không.
///
/// Mục đích: Trước khi gọi `local_auth.authenticate()`, ta phải kiểm tra
...
class DidChangeAuthLocalService {
  ...
  ///
  /// [savedToken] là token đã lưu trước đó (dùng cho iOS; Android bỏ qua).
  ///
  /// Trả về:
