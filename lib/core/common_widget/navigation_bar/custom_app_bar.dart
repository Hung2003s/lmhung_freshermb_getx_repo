...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final Widget?
  titleWidget; // Nếu muốn truyền custom Widget làm tiêu đề (vd: hình ảnh, thanh tìm kiếm)
  ...
  const CustomAppBar({
    ...
    this.leading,
    this.showBackButton =
        true, // Mặc định luôn hiện nút Back nếu có thể quay lại
    this.backgroundColor =
        Colors.black, // Bạn có thể đổi màu mặc định dự án ở đây
      ...
      leading:
          ...
          (showBackButton && Navigator.canPop(context)
              ? SelectedWidget(
                  ...
                  ), // Icon back đẹp hơn mặc định
                  onTap: () =>
                      Get.back(), // Dùng Get.back() đồng bộ với hệ thống GetX của bạn
                )
              : null),
