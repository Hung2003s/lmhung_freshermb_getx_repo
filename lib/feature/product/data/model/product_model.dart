...
abstract class ProductInfoParam with _$ProductInfoParam {
  ...
  factory ProductInfoParam.fromJson(Map<String, dynamic> json) => _$ProductInfoParamFromJson(json);
}

@freezed
abstract class UpdateProductRes with _$UpdateProductRes{
  const factory UpdateProductRes({
...
abstract class DeleteProductRes with _$DeleteProductRes{
  const factory DeleteProductRes({
    @JsonKey(name: 'data') required bool data
  }) = _DeleteProductRes;
